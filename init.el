...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-auctex which-key utop use-package undo-tree tuareg robe rainbow-delimiters pythonic multiple-cursors monokai-theme merlin magit fsharp-mode flyspell-correct-ivy epc elpy counsel cider auctex aggressive-indent ace-jump-mode))))
(custom-set-faces
